    ...
    function convertToTime(tens, seconds){
        ...
        alert(' Congratulations! Your game finished within '+ duration)
    }
  ...
  $(document).ready(function() {
    ...
    $.fn.extend({
        ...
        startPuzzle: function(image, squareSize) {
            ...
            $('#board ').append("<img id='image' src='images/london-bridge.jpg' style='width:100%;height:100%'/>");
            ...
            for (var i = 0; i < gridSize * gridSize; i++) {
                ...
                $('#board').append("<li style='left: " + ((i % 5) * squareSize) + "%; top: " + Math.floor(i / 5) * squareSize + "%; width: " + squareSize + "%; height: " + squareSize + "%; background-position: " + (-(i % 5) * squareSize) + "% " + -Math.floor(i / 5) * squareSize + "% '></li>");
    ...
    $('#game_object').startPuzzle(image, 20);
