  ...
  $(document).ready(function() {
    ...
    $.fn.extend({
        ...
        startPuzzle: function(image, squareSize) {
            ...
            $('#board ').append("<img id='image' src='images/golden-gate.jpg' style='width:100%;height:100%'/>");
            ...
            for (var i = 0; i < gridSize * gridSize; i++) {
                ...
                $('#board').append("<li style='left: " + ((i % 3) * squareSize) + "%; top: " + Math.floor(i / 3) * squareSize + "%; width: " + squareSize + "%; height: " + squareSize + "%; background-position: " + (-(i % 3) * squareSize) + "% " + -Math.floor(i / 3) * squareSize + "% '></li>");
    ...
    $('#game_object').startPuzzle(image, 33.333);
